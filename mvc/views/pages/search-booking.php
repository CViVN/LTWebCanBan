...
<div class = "container">
        <div class ="row">
            <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class = "form-title">Xin hãy nhập mã hóa đơn</div>
                <div class = "booking-form">
                    <label>Mã hóa đơn: </label>
                    <input type = "text" name = "mahd" id = "mahd" placeholder = "Ví dụ: HD-113-001">
                    <input type = "submit" class = "btn btn-primary" id = "search" name = "search" value = "Tìm kiếm">
                    <hr>
                    <div id = "hoadon" class = "container"></div>
                </div>
            </div>
        </div>
</div>
    ...
    $(document).ready(function() {
        $('#search').click(function(e) {
            ...
            if(mahd== null || mahd == "") {
                ...
                $.ajax({
                    url: 'http://localhost/live/ajax/searchbooking.php',
                    type: 'post',   
                    data:{
                        mahd,
                    },
                    success: function(data) {
                        if(data == 0){
                            $('#hoadon').html("Mã hóa đơn không đúng!");
                        }else{
                            $('#hoadon').html(data);    
                        }
                    }
