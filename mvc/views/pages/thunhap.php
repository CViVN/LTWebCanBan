...
<?php
  ...
  <div class="container">
    ...
    <nav class="navad">
      ...
      <li><a href="http://localhost/live/Admin/thunhap" class="nav-linkad active">Thu Nhập</a></li>
      </ul>
    </nav>
    <div>   
        <label><b><u>Thống kê theo ngày:</u></b></label>
        <input type = "date" name = "tk1" id ="tk1">
        <input type = "submit" class = "btn btn-primary" id = "btn1" value = "Xác nhận">
        <hr>
    </div >
    <div> 
        <label><b><u>Thống kê tháng:</u></b></label><br>
        <label>Tháng</label>
        <input type = "text" name = "tk2" id ="tk2" placeholder = "Ví dụ: 1">
        <label>Năm</label>
        <input type = "text" name = "tk3" id ="tk3" placeholder = "Ví dụ: 2023"><br>
        <input type = "submit" class = "btn btn-primary" id = "btn2" value = "Xác nhận">
        <hr>
    </div >
    <div> 
        <label><b><u>Thống kê theo năm:</u></b></label>
        <input type = "text" name = "tk4" id ="tk4" placeholder = "Ví dụ: 2023">
        <input type = "submit" class = "btn btn-primary" id = "btn3" value = "Xác nhận">
        <hr>
    </div>
    <div id ="kq"></div>
    </div>
...
<script>
     $(document).ready(function() {
        $('#btn1').click(function(){
            let ngay = $('#tk1').val();
            if(ngay == "" || ngay == null){
              alert("Hãy chọn ngày cần thống kê!");
            }else{
            $.ajax({  
        ...
        $('#btn2').click(function(){
            ...
            let nam = $('#tk3').val();
            if(thang == "" || thang == null){
              alert("Hãy chọn tháng cần thống kê!");
            }else if(nam == "" || nam == null){
              alert("Hãy chọn năm trong thống kê tháng bạn cần thống kê!");
            }else{
            $.ajax({
        ...
        $('#btn3').click(function(){
            let nam = $('#tk4').val();
            if(nam == "" || nam == null){
              alert("Hãy chọn năm cần thống kê!");
            }else{
            $.ajax({
